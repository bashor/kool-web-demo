...
public class VersionedContentTests {
    test fun `read content`() {
        ...
        assertEquals(0, vc.snapshotCallCounter)
        assertEquals(content, vc.content())
        assertEquals(1, vc.snapshotCallCounter)
        assertEquals(content, vc.content())
        assertEquals(2, vc.snapshotCallCounter)
    }
}