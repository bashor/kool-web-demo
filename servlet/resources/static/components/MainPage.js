...
var helpModelForExamples;
var helpModelForWords;
var helpViewForExamples;
var helpViewForWords;

$(function() {
    helpModelForExamples = new HelpModel("Examples");
    helpModelForWords = new HelpModel("Words");
    helpViewForExamples = new HelpView("Examples", $("#help1"), helpModelForExamples);
    helpViewForWords = new HelpView("Words", $("#help2"), helpModelForWords);
